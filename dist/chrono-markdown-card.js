import{LitElement,html,css}from"https://unpkg.com/lit@2.0.0/index.js?module";import{live}from"https://unpkg.com/lit@2.0.0/directives/live.js?module";import{styleMap}from"https://unpkg.com/lit@2.0.0/directives/style-map.js?module";import{unsafeHTML}from"https://unpkg.com/lit@2.0.0/directives/unsafe-html.js?module";import{marked}from"https://cdn.jsdelivr.net/npm/marked/lib/marked.esm.js";const CARD_VERSION="0.4.44",mdiDragHorizontalVariant="M9,3H11V5H9V3M13,3H15V5H13V3M9,7H11V9H9V7M13,7H15V9H13V7M9,11H11V13H9V11M13,11H15V13H13V11M9,15H11V17H9V15M13,15H15V17H13V15M9,19H11V21H9V19M13,19H15V21H13V19Z";console.info("%c CHRONO-%cMARKDOWN%c-CARD %c v0.4.44 ","background-color: #101010; color: #FFFFFF; font-weight: bold; padding: 2px 0 2px 4px; border-radius: 3px 0 0 3px;","background-color: #101010; color: #4676d3; font-weight: bold; padding: 2px 0;","background-color: #101010; color: #FFFFFF; font-weight: bold; padding: 2px 4px 2px 0;","background-color: #1E1E1E; color: #FFFFFF; font-weight: bold; padding: 2px 4px; border-radius: 0 3px 3px 0;");const DEFAULT_FIELD={name:"",show:!0,line_breaks:!1,content:"",font_color:"",font_size:"",font_weight:"",line_height:"",letter_spacing:"-0.012em",text_align:"",background_color:"",padding_top:8,padding_bottom:8,padding_left:8,padding_right:8,border_color:"",border_width:0,border_radius:12,border_style:"solid"},DEFAULT_CONFIG={background_color:"",padding_top:4,padding_bottom:8,padding_left:8,padding_right:8,border_color:"",border_width:1,border_radius:12,border_style:"solid",box_shadow:"",fields:[{...DEFAULT_FIELD,name:"Title",show:!1,line_breaks:!1,content:"Title",font_size:1.7,padding_bottom:12},{...DEFAULT_FIELD,name:"Content",show:!0,line_breaks:!1,content:"The **Markdown** card allows you to write any text. You can style it **bold**, *italicized*, ~strikethrough~ etc. You can do images, links, and more.\n\nFor more information see the [Markdown Cheatsheet](https://commonmark.org/help)."}]},NUMERIC_CONFIG_KEYS=new Set(["border_width","border_radius","padding_top","padding_bottom","padding_left","padding_right"]),NUMERIC_FIELD_KEYS=new Set(["font_size","font_weight","line_height","border_width","border_radius","padding_top","padding_bottom","padding_left","padding_right"]);function cmParseNumber(e){const t=String(e).replace(",",".");if("-"===t||"-0"===t||t.endsWith("."))return null;if(t.includes(".")&&t.endsWith("0"))return null;if(""===t)return"";const o=parseFloat(t);return isNaN(o)?null:o}function cmTextField(e,t,o,i={}){return html`
  ...
  `;_textAlignOptions=[{label:"Left",value:"left"},{label:"Center",value:"center"},{label:"Right",value:"right"},{label:"Justify",value:"justify"}];_borderStyleOptions=[{label:"Solid",value:"solid"},{label:"Dashed",value:"dashed"},{label:"Dotted",value:"dotted"},{label:"Double",value:"double"},{label:"Groove",value:"groove"},{label:"Ridge",value:"ridge"},{label:"Inset",value:"inset"},{label:"Outset",value:"outset"},{label:"None",value:"none"}];render(){if(!this._config)return html``;const e=this._config,t=e.fields??[];return html`
      ...
      <ha-sortable handle-selector=".handle" @item-moved=${this._fieldMoved}>
        <div class="fields-list">
          ${t.map((e,t)=>html`
            <ha-expansion-panel outlined header=${e.name||`Field ${t+1}`}>
              ...
              <div class="field-name">
                ${cmTextField("Name",e.name,e=>this._fieldChanged(t,"name",e))}
              </div>

              <!-- Row 2: Show / Line breaks toggles -->
              <div class="field-show-toggles">
                ${cmToggleField("Show",e.show??!0,e=>this._fieldToggled(t,"show",e))}
                ${cmToggleField("Line breaks",e.line_breaks??!1,e=>this._fieldToggled(t,"line_breaks",e))}
              </div>

              <!-- Row 3: Content (full width, textarea) -->
              <div class="field-content">
                ${cmTextArea("Content (supports Markdown, HTML and Jinja2)",e.content,e=>this._fieldChanged(t,"content",e))}
              </div>

              <!-- Row 4: Typography — font color, font size, font weight, line height, text align -->
              <div class="field-typography">
                ${cmColorPicker("Font color",e.font_color,e=>this._fieldChanged(t,"font_color",e))}
                ${cmTextField("Font size",e.font_size,e=>this._fieldChanged(t,"font_size",e),{type:"number",step:"0.1",min:"0"})}
                ${cmTextField("Font weight",e.font_weight,e=>this._fieldChanged(t,"font_weight",e),{type:"number",step:"100",min:"100",max:"900"})}
                ${cmTextField("Line height",e.line_height,e=>this._fieldChanged(t,"line_height",e),{type:"number",step:"0.1",min:"0"})}
                ${cmSelectField("Text align",e.text_align,this._textAlignOptions,e=>this._fieldChanged(t,"text_align",e))}
              </div>

              <!-- Row 5: Background color and padding -->
              <div class="field-bg-color-padding">
                ${cmColorPicker("Background color",e.background_color,e=>this._fieldChanged(t,"background_color",e))}
                ${cmTextField("Padding\ntop (px)",e.padding_top,e=>this._fieldChanged(t,"padding_top",e),{type:"number",step:"1",min:"0"})}
                ${cmTextField("Padding bottom (px)",e.padding_bottom,e=>this._fieldChanged(t,"padding_bottom",e),{type:"number",step:"1",min:"0"})}
                ${cmTextField("Padding left (px)",e.padding_left,e=>this._fieldChanged(t,"padding_left",e),{type:"number",step:"1",min:"0"})}
                ${cmTextField("Padding right (px)",e.padding_right,e=>this._fieldChanged(t,"padding_right",e),{type:"number",step:"1",min:"0"})}
              </div>

              <!-- Row 6: Border — color, width, radius, style -->
              <div class="field-border-styling">
                ${cmColorPicker("Border color",e.border_color,e=>this._fieldChanged(t,"border_color",e))}
                ${cmTextField("Width (px)",e.border_width,e=>this._fieldChanged(t,"border_width",e),{type:"number",step:"1",min:"0"})}
                ${cmTextField("Radius (px)",e.border_radius,e=>this._fieldChanged(t,"border_radius",e),{type:"number",step:"1",min:"0"})}
                ${cmSelectField("Style",e.border_style,this._borderStyleOptions,e=>this._fieldChanged(t,"border_style",e))}
              </div>
  ...
  `;render(){if(!this._config)return html``;const e=this._config,t={"background-color":e.background_color||void 0,"border-width":""!==e.border_width&&null!=e.border_width?`${e.border_width}px`:void 0,"border-style":e.border_style||void 0,"border-color":e.border_color||void 0,"border-radius":""!==e.border_radius&&null!=e.border_radius?`${e.border_radius}px`:void 0,"padding-top":""!==e.padding_top&&null!=e.padding_top?`${e.padding_top}px`:void 0,"padding-bottom":""!==e.padding_bottom&&null!=e.padding_bottom?`${e.padding_bottom}px`:void 0,"padding-left":""!==e.padding_left&&null!=e.padding_left?`${e.padding_left}px`:void 0,"padding-right":""!==e.padding_right&&null!=e.padding_right?`${e.padding_right}px`:void 0,"box-shadow":e.box_shadow||void 0},o=e.fields??[];return html`
      <div class="markdown-container" style=${styleMap(t)}>
        <div class="markdown-layer">
          ${o.map((e,t)=>{const o={display:!1===e.show?"none":void 0,color:e.font_color||void 0,"font-size":""!==e.font_size&&null!=e.font_size?`${e.font_size}em`:void 0,"font-weight":""!==e.font_weight&&null!=e.font_weight?`${e.font_weight}`:void 0,"text-align":e.text_align||void 0,"line-height":""!==e.line_height&&null!=e.line_height?`${e.line_height}`:void 0,"letter-spacing":e.letter_spacing||void 0,"background-color":e.background_color||void 0,"border-width":""!==e.border_width&&null!=e.border_width?`${e.border_width}px`:void 0,"border-style":e.border_style||void 0,"border-color":e.border_color||void 0,"border-radius":""!==e.border_radius&&null!=e.border_radius?`${e.border_radius}px`:void 0,"padding-top":""!==e.padding_top&&null!=e.padding_top?`${e.padding_top}px`:void 0,"padding-bottom":""!==e.padding_bottom&&null!=e.padding_bottom?`${e.padding_bottom}px`:void 0,"padding-left":""!==e.padding_left&&null!=e.padding_left?`${e.padding_left}px`:void 0,"padding-right":""!==e.padding_right&&null!=e.padding_right?`${e.padding_right}px`:void 0};return html`
              <div class="markdown-field text-field" style=${styleMap(o)}>
                ${unsafeHTML(marked.parse(this._fieldValues[t]??"",{breaks:!1!==e.line_breaks}))}
              </div>
            `})}
        </div>
      </div>
