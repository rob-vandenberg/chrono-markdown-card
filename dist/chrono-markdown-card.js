    ...
    <div class="text-field">
      ...
      <div class="color-picker-row">
        <input type="color" .value=${t||"#00000000"} @input=${o}
          @change=${e=>{"#00000000"!==e.target.value&&o(e)}}>
        <chrono-cm-textfield
          .value=${String(t??"")}
          @input=${o}
        ></chrono-cm-textfield>
