 ...
 <div align="center">
  ...
  [![](https://img.shields.io/github/v/release/rob-vandenberg/chrono-markdown-card?style=for-the-badge&color=brightgreen&label=Version)](https://github.com/rob-vandenberg/chrono-markdown-card/releases)
...
### ✍️ Markdown, HTML, and Jinja2 — All at Once
...
### 🔄 Seamless Migration from HA's Markdown Card
...
4. Enter `https://github.com/rob-vandenberg/chrono-markdown-card` and select **Lovelace** as the category.
5. Click **Add**. The repository will appear in the list.
6. Search for `Chrono Markdown Card` and click **Download**.
7. Reload your browser.

### Manual Installation

1. Download `chrono-markdown-card.js` from the [latest release](https://github.com/rob-vandenberg/chrono-markdown-card/releases/latest).
2. Copy it to your Home Assistant `config/www/` folder.
3. In Home Assistant, go to **Settings → Dashboards → Resources**.
4. Click **Add Resource**.
5. Enter `/local/chrono-markdown-card.js` as the URL and select **JavaScript Module**.
...
2. Find **Chrono Markdown Card** and click the three-dot menu.
3. Select **Remove**.
4. Reload your browser.

### Manual
1. Delete `chrono-markdown-card.js` from `config/www/`.
...
| `line_breaks` | boolean | `false` | When enabled, a single Enter key creates a new line in the rendered output. When disabled, two Enter keys are required (standard Markdown paragraph behaviour). |
| `content` | string | `''` | Field content. Supports Markdown, HTML, and Jinja2 templates. |
